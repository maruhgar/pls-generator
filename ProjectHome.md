This web application provides an interface for users to browse media folders and create playlists, which can then be passed to [Shoutcast](http://www.shoutcast.com/) server to be played.
